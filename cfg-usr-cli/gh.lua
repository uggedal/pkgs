...
vim.g.terminal_color_3 = c.orange_0
vim.g.terminal_color_11 = c.orange_1
vim.g.terminal_color_4 = c.blue_0
vim.g.terminal_color_12 = c.blue_1
vim.g.terminal_color_5 = c.pink_0
vim.g.terminal_color_13 = c.pink_1
vim.g.terminal_color_6 = c.purple_0
vim.g.terminal_color_14 = c.purple_1
